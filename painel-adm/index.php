...
$query = $pdo->query("SELECT * FROM usuarios where id = '$_SESSION[id_usuario]' and id_oficina = $id_oficina");
...
$email_usu = @$res[0]['email'];
    ...
    $menu8 = "servicos";
    $menu9 = "vendas";
    $menu10 = "configuracoes";
    $menu11 = "administrador";

//RECUPERAR DADOS DA EMPRESA    
$query_oficina = $pdo->query("SELECT * FROM oficina where id = $id_oficina");
$res_oficina = $query_oficina->fetchAll(PDO::FETCH_ASSOC);
$nome_oficina = $res_oficina[0]['nome'];
$email = $res_oficina[0]['email'];
$logo = $res_oficina[0]['imagem'];
$endereco_oficina = $res_oficina[0]['endereco_oficina'];
$telefone_oficina = $res_oficina[0]['telefone_oficina'];     


//VERIFICAR NIVEL DO ESTOQUE
$query = $pdo->query("SELECT * FROM produtos where estoque < '$nivel_estoque' and id_oficina = $id_oficina");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$nivel_est = @count($res);
if($nivel_est > 0){
...
<html lang="pt-br">
    ...
    <body id="page-top">
    <?php //echo"<pre>";print_r($_SESSION['id_oficina']);echo"</pre>"; ?>
        <!-- Page Wrapper -->
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>&id_oficina=<?php echo $_SESSION['id_oficina'] ?>">Mecanicos</a>
                            ...
                            <?php if($id_oficina == '1'){?>
                                <a class="collapse-item" href="index.php?pag=<?php echo $menu11 ?>">Administrador</a>
                            <?php }?>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?pag=<?php echo $menu10 ?>">
                        <i class="fa fa-cog"></i>
                        <span class="">Configurações</span></a>
                </li>                
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <img src="../img/<?=$id_oficina?>/<?=$logo?>" width="85">
