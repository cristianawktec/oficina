...
$query = $pdo->query("SELECT * FROM recepcionistas where id = '$id' and id_oficina = '$id_oficina'");
...
$pdo->query("DELETE FROM recepcionistas WHERE id = '$id' and id_oficina = '$id_oficina'");
